...
! function($) {
	...
	FlotChart.prototype.init = function() {
		...
		var datas = [20, 30, 15];
		var colors = ["#228bdf", "#ef5350", "#ec971f"];
		this.createPieGraph("#pie-chart #pie-chart-container", pielabels, datas, colors);

		//real time data representation
		var plot = this.createRealTimeGraph('#flotRealTime', this.randomData(), ['#228bdf']);
		plot.draw();
		var $this = this;
		function updatePlot() {
		...
		var donutcolors = ["#00b19d", "#ffaa00", "#f76397", "#7266ba"];
