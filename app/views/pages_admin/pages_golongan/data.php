    ...
    <div class="col-lg-12">
        <div class="panel panel-border panel-color-primary ">
            ...
            <div class="panel-body table-responsive">
                <table class="table table-striped table-bordered dt-responsive nowrap table-golongan">
                    <thead>
                        <tr>
                            <th width="1%" style="text-align: center; font-size:12px;">No</th>
                            <th width="15%" style="text-align: center; font-size:12px;">Kenaikan Ke</th>
                            <th width="10%" style="text-align: center; font-size:12px;">AKK</th>
                            <th width="10%" style="text-align: center; font-size:12px;">PD</th>
                            <th width="10%" style="text-align: center; font-size:12px;">PI</th>
                            <th width="10%" style="text-align: center; font-size:12px;">KI</th>
                            <th width="10%" style="text-align: center; font-size:12px;">AKP</th>
                            <th width="10%" style="text-align: center; font-size:12px;">AKPBM</th>
