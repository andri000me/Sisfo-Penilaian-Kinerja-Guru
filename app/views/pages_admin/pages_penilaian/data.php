    ...
    <div class="col-lg-12">
        <div class="panel panel-border panel-color-primary ">
            ...
            <div class="panel-body table-responsive">
                <table class="table table-striped table-bordered dt-responsive nowrap table-penilaian">
                    <thead>
                        <tr>
                            ...
                            <th width="15%" style="text-align: center; font-size:12px;">Nama Kompetensi</th>
                            <th width="15%" style="text-align: center; font-size:12px;">Nilai</th> 
