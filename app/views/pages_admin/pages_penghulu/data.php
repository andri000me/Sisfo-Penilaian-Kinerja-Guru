    ...
    <div class="col-lg-12">
        <div class="panel panel-border panel-color-primary ">
            ...
            <div class="panel-body table-responsive">
                <table class="table table-striped table-bordered dt-responsive nowrap table-penghulu">
                    <thead>
                        <tr>
                            <th width="1%" style="text-align: center; font-size:12px;">No</th>
                            <th width="15%" style="text-align: center; font-size:12px;">Nama Penghulu</th> 
                            <th width="15%" style="text-align: center; font-size:12px;">Jabatan Penghulu</th>
