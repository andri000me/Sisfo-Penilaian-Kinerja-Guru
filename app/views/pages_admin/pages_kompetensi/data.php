    ...
    <div class="col-lg-12">
        <div class="panel panel-border panel-color-primary ">
            ...
            <div class="panel-body table-responsive">
                <table class="table table-striped table-bordered dt-responsive nowrap table-kompetensi">
                    <thead>
                        <tr>
                            ...
                            <th width="45%" style="text-align: center; font-size:12px;">Nama Kompetensi</th>
