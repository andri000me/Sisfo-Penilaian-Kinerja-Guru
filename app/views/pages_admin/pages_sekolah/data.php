    ...
    <div class="col-lg-12">
        <div class="panel panel-border panel-color-primary ">
            ...
            <div class="panel-body table-responsive">
                <table class="table table-striped table-bordered dt-responsive nowrap table-sekolah">
                    <thead>
                        <tr>
                            ...
                            <th width="15%" style="text-align: center; font-size:12px;">No Telp</th>
                            <th width="15%" style="text-align: center; font-size:12px;">Provinsi</th>
                            <th width="15%" style="text-align: center; font-size:12px;">Kabupaten</th>
                            <th width="15%" style="text-align: center; font-size:12px;">Kecamatan</th>
                            <th width="15%" style="text-align: center; font-size:12px;">Kelurahan</th>
